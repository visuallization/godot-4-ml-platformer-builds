...
if args.resume_model_path is None:
    model = PPO("MultiInputPolicy", env, ent_coef=0.005, verbose=2, n_steps=64, batch_size=1024, learning_rate=0.0003, n_epochs=3, gamma=0.99, clip_range=0.2, gae_lambda=0.95, tensorboard_log=args.experiment_dir)
else:
